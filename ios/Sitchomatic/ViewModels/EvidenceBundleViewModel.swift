...
class EvidenceBundleViewModel {
    ...
    var filteredBundles: [EvidenceBundle] {
        ...
        case .unsure: base = service.bundles.filter { $0.resultStatus == .unsure || $0.resultStatus == .noAcc }
    ...
    func countFor(_ filter: BundleFilter) -> Int {
        ...
        case .unsure: service.bundles.filter { $0.resultStatus == .unsure || $0.resultStatus == .noAcc }.count
