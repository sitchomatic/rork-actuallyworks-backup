...
nonisolated enum LoginFormPattern: String, CaseIterable, Codable, Sendable {
    ...
    var description: String {
        switch self {
        case .trueDetection:
            "Hardcoded Interaction Protocol: Triple-Wait → site-specific selectors (Joe: #username/#password/#loginSubmit, Ign: #email/#login-password/#login-submit) with force dispatch"
        case .tabNavigation:
