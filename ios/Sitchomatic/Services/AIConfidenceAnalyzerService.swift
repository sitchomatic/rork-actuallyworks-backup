...
class AIConfidenceAnalyzerService {
    ...
    func shouldUseAIFallback(confidence: Double) -> Bool { false }
    ...
    ) async -> AIClassificationResult? { nil }

    func learnedKeywordBoost(host: String, pageContent: String) -> (outcome: String, boost: Double)? { nil }
    ...
    func statsForHost(_ host: String) -> HostKeywordProfile? { nil }
