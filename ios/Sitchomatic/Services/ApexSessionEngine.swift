...
class LoginSiteWebSession: NSObject {
    ...
    func rapidSuccessPoll(timeout: TimeInterval, originalURL: String) async -> (successTextFound: Bool, redirectedToHomepage: Bool, navigationDetected: Bool, errorBannerDetected: Bool, smsNotificationDetected: Bool, finalPageContent: String, finalURL: String) {
        let start = Date()
        ...
        (function() {
            ...
            var successTerms = ['my account','logged in','lobby','your balance','my wallet','logout','log out'];
